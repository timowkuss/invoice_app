...
CREATE INDEX IF NOT EXISTS idx_one_c_connections_store ON one_c_connections(store_id);
...
CREATE INDEX IF NOT EXISTS idx_products_article ON products(store_id, article);
...
CREATE INDEX IF NOT EXISTS idx_product_aliases_store ON product_aliases(store_id);
CREATE INDEX IF NOT EXISTS idx_product_aliases_normalized ON product_aliases(store_id, normalized_text);
...
CREATE INDEX IF NOT EXISTS idx_documents_supplier ON documents(store_id, supplier);
CREATE INDEX IF NOT EXISTS idx_documents_hash ON documents(original_file_hash);
CREATE INDEX IF NOT EXISTS idx_documents_telegram ON documents(telegram_message_id);
...
CREATE INDEX IF NOT EXISTS idx_document_items_status ON document_items(match_status);
...
CREATE INDEX IF NOT EXISTS idx_ai_requests_store ON ai_requests(store_id);
CREATE INDEX IF NOT EXISTS idx_ai_requests_document ON ai_requests(document_id);
CREATE INDEX IF NOT EXISTS idx_ai_requests_created ON ai_requests(created_at);
CREATE INDEX IF NOT EXISTS idx_ai_requests_provider ON ai_requests(provider, created_at);
